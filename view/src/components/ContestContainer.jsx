...
export default function ContestContainer({ contest, permissions, refreshContests }){
          ...
          (
            ...
            {loadingDelete ? (
              <button
                ...
                type="submit"
              >
                <CircularProgress size={23} thickness={4} color="inherit" >Delete</CircularProgress>
              </button>
            ) : (
              <button
