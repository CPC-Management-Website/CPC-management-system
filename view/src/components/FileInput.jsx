...
export default function FileInput({title, loading, submitHandler}){
    const [selectedFile, setSelectedFile] = useState("");
    return(
        <>
            <form className="flex flex-col lg:w-[40%]" onSubmit={(e)=>{ e.preventDefault(); submitHandler(selectedFile)}}>
