...
function ResetPassword() {
    ...
    const [{ loading, loadingReset, validToken }, dispatch] = useReducer(reducer, {
        loading: true,
        loadingReset: false,
        validToken: false,
        error: "",
    ...
    const checkTokenValidity = async(e) => {
        try {
            ...
            const params = new URLSearchParams([["token",searchParams.get("token")]]);
            const response = await axios.get(
            URLS.RESET_PASSWORD,{params}
            );
            ...
            (
                (validToken === false)? (
                    ...
                    <div className="flex flex-col p-4 lg:p-0  lg:items-center">
                        <p className="text-3xl font-semibold lg:my-10 mb-4">Reset Password</p>
